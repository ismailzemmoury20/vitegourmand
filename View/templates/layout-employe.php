...
<head>
    ...
    <link rel="stylesheet" href="/css/espace.css?v=<?= filemtime(__DIR__ . '/../../public/css/espace.css') ?>">
    <?php if (!empty($style)): ?>
...
<body class="corps-espace">
    ...
    <?php else: ?>
        <?php require __DIR__ . '/../partials/sidebar-employe.php'; ?>
    <?php endif; ?>
    <main class="espace-contenu">
        <?= $contenu ?>
    </main>
    <script src="/js/popups.js?v=<?= filemtime(__DIR__ . '/../../public/js/popups.js') ?>"></script>
    <script src="/js/espace.js?v=<?= filemtime(__DIR__ . '/../../public/js/espace.js') ?>"></script>
    <?php if (!empty($script)): ?>
