<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        <a class="sidebar-lien <?= ($pageActive ?? '') === 'commandes' ? 'actif' : '' ?>" href="/index.php?p=commandes">
        ...
        <a class="sidebar-lien <?= ($pageActive ?? '') === 'informations' ? 'actif' : '' ?>" href="/index.php?p=mes-informations">
