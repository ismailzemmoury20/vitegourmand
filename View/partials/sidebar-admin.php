<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        <a class="sidebar-lien <?= ($pageActive ?? '') === 'dashboard' ? 'actif' : '' ?>" href="/vitegourmand/public/index.php?p=admin-dashboard">
        ...
        <a class="sidebar-lien <?= ($pageActive ?? '') === 'employes' ? 'actif' : '' ?>" href="/vitegourmand/public/index.php?p=admin-employes">
        ...
        <a class="sidebar-lien <?= ($pageActive ?? '') === 'admins' ? 'actif' : '' ?>" href="/vitegourmand/public/index.php?p=admin-admins">
        ...
        <a class="sidebar-lien <?= ($pageActive ?? '') === 'clients' ? 'actif' : '' ?>" href="/vitegourmand/public/index.php?p=admin-clients">
        ...
        <a class="sidebar-lien <?= ($pageActive ?? '') === 'menus' ? 'actif' : '' ?>" href="/vitegourmand/public/index.php?p=admin-menus">
